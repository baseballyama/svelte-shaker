...
- 6f5d525: The monomorphization size proxy is now computed with rsvelte, so the native engine runs the whole gate in-process — no JS-compiler callback.
